 ...
 */
public class GyroscopeChartView extends ChartView {

    public final int visibleX=50;

    public GyroscopeChartView(DataActivity context, Feature feature) {
            ...
            public void onUpdate(Feature f, final Feature.Sample sample) {
                mContext.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        data.addEntry(new Entry(FeatureGyroscope.getGyroX(sample), data.getDataSetByIndex(0).getEntryCount()), 0);
                        data.addEntry(new Entry(FeatureGyroscope.getGyroY(sample), data.getDataSetByIndex(1).getEntryCount()), 1);
                        data.addEntry(new Entry(FeatureGyroscope.getGyroY(sample), data.getDataSetByIndex(2).getEntryCount()), 2);
