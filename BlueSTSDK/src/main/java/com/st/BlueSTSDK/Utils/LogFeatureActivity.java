...
public abstract class LogFeatureActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mCurrentLogger==null) {
            menu.findItem(R.id.startAllLog).setVisible(true);
            menu.findItem(R.id.stopAllLog).setVisible(false);
        } else {
            menu.findItem(R.id.startAllLog).setVisible(false);
            menu.findItem(R.id.stopAllLog).setVisible(true);
        }//if-else
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.startAllLog) {
            startLogging(getNodeToLog());
            invalidateOptionsMenu();
            return true;
        }
        if (id == R.id.stopAllLog) {
